...
#
# Напишите программу, которая спрашивает у пользователя, ушёл человек или пришёл новый гость, и исходя
...
while True:
    ...
    if question == 'Пора спать':
        print('Вечеринка закончена, все легли спать.')
        break
