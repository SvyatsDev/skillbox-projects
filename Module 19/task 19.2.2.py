# Мы работаем в одной небольшой торговой компании, где все данные о продажах фруктов за год сохранены в словаре в виде
# пар «название фрукта — доход»:
# incomes = {
#     'apple': 5600.20,
#     'orange': 3500.45,
#     'banana': 5000.00,
...
min_income = ''
for i_name in incomes.keys():
    if incomes.get(i_name) == min(incomes.values()):
        min_income = i_name
incomes.pop(min_income)
print('Самый маленький доход у', min_income, '-', min(incomes.values()))
print(incomes)